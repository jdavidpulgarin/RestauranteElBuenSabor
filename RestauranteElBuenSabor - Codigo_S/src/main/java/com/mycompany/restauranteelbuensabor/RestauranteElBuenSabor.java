...
// agrega al pedido
                        Datos.cantidad[numeroProducto - 1] = Datos.cantidad[numeroProducto - 1] + c;
                        System.out.println("Producto agregado al pedido.");
                        System.out.println("  -> " + Datos.nombre[numeroProducto - 1] + " x" + c);
                       numeroMesa = Datos.precios[numeroProducto - 1] * c;
                    } else {
                        if (c == 0) {
// cantidad es cero
